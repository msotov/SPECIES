      ...
      DIMENSION F(700)                                                          
      DIMENSION UWAVE(29),VWAVE(29),BWAVE(29),YWAVE(29)                         
      DIMENSION U1(29),U2(29)                                                   
      REAL M1                                                                   
      DIMENSION U(29),V(29),B(29),Y(29)                                         
      DIMENSION UFILT(29),VFILT(29),BFILT(29),YFILT(29)                         
...
c     actually l/h
     ...
     1UMAG,U0MAG,VMAG,BMAG,YMAG,UMINB,U0MINB,BMINY,M1,C1,C10
   60 FORMAT(I6,I6,5F6.2,11F8.3)
     ...
     2UMAG,U0MAG,VMAG,BMAG,YMAG,UMINB,U0MINB,BMINY,M1,C1,C10
  900 CONTINUE                                                                  
 1000 CONTINUE                                                                  
    9 CALL EXIT                                                                 
      END                                                                       
